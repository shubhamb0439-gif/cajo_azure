/*
  # Fix Assembly Transaction Function Security

  ## Changes
  - Add SECURITY DEFINER to execute_assembly_transaction function
  - This allows the function to bypass RLS policies when called from edge functions
  - The function already validates inputs and performs proper authorization checks
  
  ## Security Notes
  - Function is called from edge function which validates user authentication
  - Edge function already performs stock validation before calling this function
  - SECURITY DEFINER needed to modify inventory_items, purchase_items, etc. with RLS enabled
*/
