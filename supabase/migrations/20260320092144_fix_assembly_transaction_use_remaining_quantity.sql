/*
  # Fix Assembly Transaction to Use Remaining Quantity

  ## Changes
  - Update execute_assembly_transaction function to use `remaining_quantity` instead of `quantity_used`
  - The purchase_items table uses `remaining_quantity` (amount left to use) not `quantity_used`
  - Update logic to deduct from remaining_quantity and check remaining_quantity > 0
